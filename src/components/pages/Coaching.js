  ...
  return (
    <div className='coaching-page'>
      ...
      <div className='white-background'>
        ...
        <h3>Warum funktioniert es?</h3>
        <p>Lösungsfokussiertes Denken fördert nachweislich positive neuronale Veränderungen. Durch gezieltes Übung werden neue neuronale Verknüpfungen geschaffen, die es erleichtern, den Fokus auf Möglichkeiten statt auf Hindernisse zu richten. Dieses "mentale Training" stärkt nicht nur Ihre Problemlösungskompetenz, sondern auch Ihre emotionale Resilienz.</p>
      ...
      <div className='white-background'>
        ...
        <ul>
          <li>Menschen, die schnelle und nachhaltige Veränderungen anstreben</li>
